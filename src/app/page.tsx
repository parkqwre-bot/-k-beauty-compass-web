...
export default function Home() {
  ...
  const questions: QuizQuestion[] = [
    ...
    {
      questionText: String(getTranslation(currentLocale, "q_skin_feel")),
      options: [
        String(getTranslation(currentLocale, "a_skin_feel_dry")),
        String(getTranslation(currentLocale, "a_skin_feel_normal")),
        String(getTranslation(currentLocale, "a_skin_feel_oily")),
        String(getTranslation(currentLocale, "notSure")),
      ],
      allowMultipleSelection: false,
    },
    {
      questionText: String(getTranslation(currentLocale, "q_skin_concern")),
      options: [
        String(getTranslation(currentLocale, "a_concern_acne")),
        String(getTranslation(currentLocale, "a_concern_pore")),
        String(getTranslation(currentLocale, "a_concern_aging")),
        String(getTranslation(currentLocale, "a_concern_sensitive")),
        String(getTranslation(currentLocale, "a_concern_brightening")),
      ],
      allowMultipleSelection: true,
    },
    {
      questionText: String(getTranslation(currentLocale, "q_sensitivity")),
      options: [
        String(getTranslation(currentLocale, "a_sensitivity_yes_often")),
        String(getTranslation(currentLocale, "a_sensitivity_yes_sometimes")),
        String(getTranslation(currentLocale, "a_sensitivity_no")),
        String(getTranslation(currentLocale, "notSure")),
      ],
      allowMultipleSelection: false,
    },
